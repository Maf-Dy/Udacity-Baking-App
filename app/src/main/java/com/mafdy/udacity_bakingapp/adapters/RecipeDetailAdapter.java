...
import com.mafdy.udacity_bakingapp.objects.Step;
...
public class RecipeDetailAdapter extends RecyclerView.Adapter<RecipeDetailAdapter.RecyclerViewHolder> {
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        int layoutIdForListItem = R.layout.item_recycler_list_recipe_detail_item;
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int position) {
        ...
        if(lSteps.get(position).getVideoURL().equals(""))
            holder.imageViewHasVideo.setVisibility(View.INVISIBLE);
        else
            holder.imageViewHasVideo.setVisibility(View.VISIBLE);
    ...
    class RecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ImageView imageViewHasVideo;

        public RecyclerViewHolder(View itemView) {
            super(itemView);

            textRecyclerView = (TextView) itemView.findViewById(R.id.description);
            imageViewHasVideo = (ImageView) itemView.findViewById(R.id.hasvideo);
