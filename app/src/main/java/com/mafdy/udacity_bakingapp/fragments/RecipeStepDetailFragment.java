...
import static com.mafdy.udacity_bakingapp.MainActivity.SELECTED_INDEX;
import static com.mafdy.udacity_bakingapp.MainActivity.SELECTED_RECIPES;
import static com.mafdy.udacity_bakingapp.MainActivity.SELECTED_STEPS;
...
public class RecipeStepDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (!videoURL.isEmpty()) {
            ...
            player=null;
            simpleExoPlayerView.setForeground(ContextCompat.getDrawable(getContext(), R.drawable.video_off));
        ...
        mPrevStep.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (steps.get(selectedIndex).getId() > 0) {
                    ...
                    itemClickListener.onListItemClick(steps,selectedIndex - 1,recipeName);
                }
                else {
